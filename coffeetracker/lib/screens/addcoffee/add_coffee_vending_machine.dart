...
class AddCoffeeVendingMachine extends StatefulWidget {
  const AddCoffeeVendingMachine({super.key});

  @override
  _AddCoffeeVendingMachineState createState() => _AddCoffeeVendingMachineState();
}

class _AddCoffeeVendingMachineState extends State<AddCoffeeVendingMachine> {
  ...
  void _saveData() async {
    ...
    Map<String, dynamic> newRecord = {
      ...
      'coffee_shop': '',
      'brand': _vendingMachineBrandController.text, // Add logic for brand if needed
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              const SizedBox(height: 45), // add space on the bottom
            ],
          ),
        ),
      ),
